ServerEvents.recipes(event => {
    ...
    orechid('minecraft:stone', 'primalmagick:infused_stone_earth', 4000)
    orechid('minecraft:stone', 'primalmagick:infused_stone_sky', 4000)
    orechid('minecraft:stone', 'primalmagick:infused_stone_sun', 4000)
    orechid('minecraft:stone', 'primalmagick:infused_stone_moon', 4000)
    orechid('minecraft:stone', 'primalmagick:infused_stone_sea', 4000)
    ...
    event.shaped('botania:gaia_pylon', [
            ...
            A: 'primalmagick:essence_dust_moon',
            P: 'botania:mana_pylon',
            e: 'botania:elementium_ingot',
            E: 'primalmagick:essence_dust_earth'
        }
    )
